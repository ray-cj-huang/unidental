...
const services = [
  ...
  {
    name: 'Denture',
    description: 'A prosthetic device constructed to replace missing teeth, and is supported by surrounding tissues',
    href: '#',
    icon: EmojiHappyIcon,
  },
  {
    name: 'Bridges',
    description: "A fixed dental restoration used to replace missing teeth by joining an artificial tooth to adjacent teeth or implants",
    href: '#',
    icon: ExclamationCircleIcon,
  },
  {
    name: 'Filling',
    description: 'A treatment used to restore the function, integrity, and morphology of missing tooth structure from caries or external trauma',
    href: '#',
    icon: HeartIcon,
  },
  {
    name: 'Crowns',
    description: 'A dental cap, a type of dental restoration that completely caps or encircles a tooth or dental implant',
    href: '#',
